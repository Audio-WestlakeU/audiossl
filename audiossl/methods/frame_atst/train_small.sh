...
mask_len=5
use_mse=8
name=use_mse${use_mse}use_cls${use_cls}unmask_for_cls${unmask_for_cls}crop_ratio${crop_ratio}symmetric${symmetric}aug_tea${aug_tea}aug_stu${aug_stu}mask_ratio${mask_ratio}mask_type${mask_type}avg_blocks${avg_blocks}_patch_h${patch_h}patch_w${patch_w}_nproc${nproc}_batch_size${batch_size}_mask_len${mask_len}
