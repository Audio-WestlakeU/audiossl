...
from model_cls import ClsPromptLightningModule
from data_cls import ClsPromptDataModule
...
def main(args):
    ...
    model = ClsPromptLightningModule(**dict_args)                            
    data = ClsPromptDataModule(**dict_args)
...
if __name__ == "__main__":
    ...
    parser = ClsPromptLightningModule.add_model_specific_args(parser)
    parser = ClsPromptDataModule.add_data_specific_args(parser)
