...
class FrameATSTTrainTransform:
    def __init__(self,sr=16000,aug_tea=True,aug_stu=True,mask_ratio=0.75,mask_len=5,mask_type="random",anchor_len=6.,patch_h=64,patch_w=4,**kwargs):
    ...
    def __call__(self,input):
        ...
        if self.mask_type == "random":
            ...
            mask = random_mask.get_mask(1,num_patches,self.mask_ratio,no_overlap=False,min_length=self.mask_len).squeeze(0)
