...
import warnings
import math
from audiossl.methods.promptpool import random_mask
...
class FrameAST(nn.Module):
    """ Vision Transformer """
    def __init__(self,use_cls=0,use_unmask_for_cls=True,  crop_ratio=0.6, use_mse=0,avg_blocks=0, spec_h=64,spec_w=1001, patch_w=4,patch_h=64, in_chans=1, num_classes=0, embed_dim=768, depth=12,
