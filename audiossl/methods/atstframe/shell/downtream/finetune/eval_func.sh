...
eval()
{
        ...
        local save_path=`dirname $pretrained_ckpt_path`/${ds_name}/last_blocks_${n_last_blocks}_batchsize${batch_size}_lr${lr}_mixup${mixup_training}_max_epochs${max_epochs}
