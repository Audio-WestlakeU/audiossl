...
class FrameATSTLightningModule(LightningModule):
    ...
    def training_step(self,batch,batch_idx):
        ...
        self.log("epoch", self.current_epoch, on_epoch=True, on_step=True, sync_dist=True)
        self.log("loss_frm",total_loss_frm,prog_bar=True, on_step=True,on_epoch=True,logger=True, sync_dist=True)
        self.log("std_frm_tea",std_frm_tea,on_step=True,on_epoch=True,logger=True, sync_dist=True)
        self.log("std_frm_stu",std_frm_stu,on_step=True,on_epoch=True,logger=True, sync_dist=True)
        self.log("ema",self.ema_scheduler[self.global_step],logger=True, sync_dist=True)
        self.log("step",self.global_step,on_epoch=True,logger=True, sync_dist=True)
    ...
    def schedule(self):
        ...
        self.log("wd",self.wd_scheduler[self.global_step],logger=True, sync_dist=True)
        self.log("lr",param_group["lr"],logger=True, sync_dist=True)
